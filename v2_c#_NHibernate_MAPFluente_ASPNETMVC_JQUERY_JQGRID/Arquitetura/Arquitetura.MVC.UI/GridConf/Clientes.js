$().ready(function () {
    ...
    $("#tbGrid").jqGrid({
        ...
        mtype: 'POST',
        colNames: ['ID', 'Nome', 'Cep', 'logradouro', 'tipo', 'cidade', 'bairro', 'estado'],
        colModel: [
                   ...
                   { name: 'logradouro', index: 'logradouro', searchoptions: { sopt: ['eq', 'cn'] }, width: 80, editable: true, editoptions: { size: 20} },
                   { name: 'tipo', index: 'tipo', searchoptions: { sopt: ['eq', 'cn'] }, width: 150, editable: true, editoptions: { size: 20} },
                   { name: 'cidade', index: 'cidade', searchoptions: { sopt: ['eq', 'cn'] }, width: 80, editable: true, editoptions: { size: 20} },
                   { name: 'bairro', index: 'bairro', searchoptions: { sopt: ['eq', 'cn'] }, width: 150, editable: true, editoptions: { size: 20} },
                   { name: 'estado', index: 'estado', searchoptions: { sopt: ['eq', 'cn'] }, width: 80, editable: true, editoptions: { size: 20} }
                ],
        rowNum: 10,
